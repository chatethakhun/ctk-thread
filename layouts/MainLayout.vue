<template>
    <div id="MainLayout" class="h-screen">
        ...
        <div id="BottomNav" class="fixed z-50 bottom-0 flex w-full h-[70px] border-t border-t-grey-700 bg black">
            <div class="flex w-full max-w-[500px] mx-auto items-center justify-around">
                <button @click="navigateTo('/')" class="w-full h-full">
                    <Icon class="mb-1" name="material-symbols:home-outline" size="35" color="#fff"/>
                </button>
